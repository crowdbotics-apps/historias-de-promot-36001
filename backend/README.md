...
## Project Structure
    ...
    ├── historias_de_promot_36001  # Django project configurations
...
1. Clone this repo and `cd historias_de_promot_36001`
...
2. Clone this repo and `cd historias_de_promot_36001`
